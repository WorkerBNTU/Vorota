...
- Геопродвижение: Беларусь в H1/title; бренды (DoorHan и др.) — в дилерских формулировках, description и полях manufacturer; канонический домен `SITE_URL`, без редиректа со старого независимого сайта.
